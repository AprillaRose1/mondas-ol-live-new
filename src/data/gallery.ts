...
export const MOCK_GALLERY: GalleryImage[] = [
  {
    ...
    title: { de: 'Olivenhain bei Sonnenaufgang', en: 'Olive Grove at Sunrise', fr: 'Oliveraie au lever du soleil', ar: 'بستان الزيتون عند شروق الشمس' },
    category: 'nature',
  },
  {
    id: '2',
    url: 'https://images.unsplash.com/photo-1505932794465-147d1f1b2c97?auto=format&fit=crop&q=80&w=1000',
    title: { de: 'Frisch gepresstes Öl', en: 'Freshly Pressed Oil', fr: 'Huile fraîchement pressée', ar: 'زيت معصور طازجاً' },
    category: 'product',
  },
  {
    id: '3',
    url: 'https://images.unsplash.com/photo-1464306311035-642136709731?auto=format&fit=crop&q=80&w=1000',
    title: { de: 'Traditionelle Ernte', en: 'Traditional Harvest', fr: 'Récolte traditionnelle', ar: 'الحصاد التقليدي' },
    category: 'tradition',
  },
  {
    id: '4',
    url: 'https://images.unsplash.com/photo-1543362906-acfc16c67564?auto=format&fit=crop&q=80&w=1000',
    title: { de: 'Goldene Oliven', en: 'Golden Olives', fr: 'Olives dorées', ar: 'زيتون ذهبي' },
    category: 'nature',
  },
  {
    id: '5',
    url: 'https://images.unsplash.com/photo-1502472545331-db0df3019865?auto=format&fit=crop&q=80&w=1000',
    title: { de: 'Küchen-Ästhetik', en: 'Kitchen Aesthetics', fr: 'Esthétique de la cuisine', ar: 'جماليات المطبخ' },
    category: 'lifestyle',
  },
  {
    id: '6',
    url: 'https://images.unsplash.com/photo-1547514701-42782101795e?auto=format&fit=crop&q=80&w=1000',
    title: { de: 'Die Kunst des Öls', en: 'The Art of Oil', fr: "L'art de l'huile", ar: 'فن الزيت' },
    category: 'product',
  },
];
